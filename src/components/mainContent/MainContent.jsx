  ...
  return (
    <main className="main">
      ...
      <div className={`cart-card${props.cartClicked ? '-open' : ''}`}>
        <Cart deleteCartItem={props.deleteCartItem.deleteCartItem} title={props.product.title} price={props.product.discounted} quantity={props.ItemsNo} isdeleted={props.isDeleted} cartOpened={props.cartOpened} />
      </div>
